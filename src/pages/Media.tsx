    ...
    <div className="bg-white min-h-screen font-sans selection:bg-cyan-200 selection:text-slate-900">
      ...
      <section className="py-24 bg-white" id="news">
        <div className="w-full px-8 lg:px-[15vw]">
          <div className="flex flex-col lg:flex-row justify-between items-end mb-8 lg:mb-12 gap-4 border-b border-[#004080] pb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-12">
            <div className="group cursor-pointer">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-4 text-[#90A1B9] border-t border-gray-200 pt-3">
                ...
                <h2 className="text-[36px] md:text-[40px] font-bold text-[#004080] leading-none tracking-tight group-hover:text-black transition-colors duration-300">{featuredNews?.title}</h2>
            ...
            <div className="flex flex-col">
              ...
              <div className="flex-grow">
                {restNews.map((item, idx) => (
                  <div key={idx} className="group/item cursor-pointer border-t border-gray-200 py-5 px-[15px] first:border-t-0 hover:bg-gray-50 transition-all -mx-[15px]">
                    ...
                    <h4 className="text-xl font-bold text-slate-800 mb-1 leading-tight group-hover/item:text-[#004080] transition-colors">{item.title}</h4>
                    <div className="flex justify-between items-center mt-2 opacity-0 group-hover/item:opacity-100 transition-opacity">
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-200">
        <div className="w-full px-8 lg:px-[15vw]">
          <div className="mb-6">
            ...
            <p className="text-slate-500 mt-0.5">{t('mediaPage.perspectivesSubtitle')}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-auto md:h-[500px]">
            <div className="md:col-span-2 relative group cursor-pointer overflow-hidden bg-white border border-slate-200 hover:shadow-xl transition-all">
              ...
              <div className="absolute bottom-0 left-0 p-6 md:p-8">
                <Badge className="bg-cyan-500 border-none text-white mb-1.5 rounded-none">{insights[0]?.tag}</Badge>
                <h3 className="text-3xl font-bold text-white mb-2 leading-tight">{insights[0]?.title}</h3>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex-1 bg-white p-6 border border-slate-200 hover:border-cyan-300 transition-colors group cursor-pointer flex flex-col justify-center">
                <div className="text-cyan-600 text-xs font-bold uppercase tracking-widest mb-1">{insights[1]?.tag}</div>
                <h3 className="text-xl font-bold text-slate-900 mb-0 group-hover:text-cyan-700">{insights[1]?.title}</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="w-full px-8 lg:px-[15vw]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-7 border-t lg:border-t-0 lg:border-l border-slate-200 pt-10 lg:pt-0 lg:pl-10">
              <div className="flex items-center justify-between mb-5">
