...
export const ContactFormSection: React.FC = () => {
  ...
  return (
    <div className="w-full px-8 lg:px-[15vw] py-12 md:py-14 lg:py-16">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12">
        <div className="lg:col-span-5 space-y-5">
          <div className="bg-[rgb(0,64,128)] text-white p-6 md:p-7 flex flex-col justify-between relative overflow-hidden group">
            <div className="relative z-10">
              <h3 className="text-xl md:text-2xl font-bold mb-5 border-l-4 border-cyan-500 pl-4 text-[rgb(255,255,255)]">{t('contactForm.hqTitle')}</h3>
              <div className="space-y-5">
                <div className="flex gap-4 group/item">
                  <div className="w-10 h-10 bg-white/10 flex items-center justify-center text-cyan-400 flex-shrink-0 group-hover/item:bg-cyan-500 group-hover/item:text-slate-950 transition-colors">
                    <MapPin size={18} />
                  </div>
                  <div>
                ...
                <div className="flex gap-4 group/item">
                  ...
                  <div>
                    ...
                    <p className="text-white text-base">+243 81 000 0000</p>
                  </div>
                </div>
                <div className="flex gap-4 group/item">
                  <div className="w-10 h-10 bg-white/10 flex items-center justify-center text-cyan-400 flex-shrink-0 group-hover/item:bg-cyan-500 group-hover/item:text-slate-950 transition-colors">
                  ...
                  <div>
                    ...
                    <p className="text-white text-base">info@itmafrica.com</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-slate-50 p-5 md:p-6 border border-slate-100 flex items-center justify-between gap-4">
            <div>
        ...
        <div className="lg:col-span-7">
          <div className="bg-white p-0">
            <div className="mb-6 md:mb-8">
              <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-2">{t('contactForm.formTitle')}</h2>
              <p className="text-slate-500 text-base leading-relaxed">{t('contactForm.formIntro')}</p>
            </div>
            ...
            <form className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  <Input placeholder={t('contactForm.namePlaceholder')} className="h-12 bg-slate-50 border-slate-200 focus:border-cyan-500 focus:ring-0 rounded-none transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-slate-900 uppercase tracking-wider">{t('contact.form.email')}</label>
                  <Input type="email" placeholder={t('contactForm.emailPlaceholder')} className="h-12 bg-slate-50 border-slate-200 focus:border-cyan-500 focus:ring-0 rounded-none transition-all" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  <Input placeholder={t('contactForm.phonePlaceholder')} className="h-12 bg-slate-50 border-slate-200 focus:border-cyan-500 focus:ring-0 rounded-none transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-slate-900 uppercase tracking-wider">{t('contactForm.divisionsLabel')}</label>
                  <Select>
                    <SelectTrigger className="h-12 bg-slate-50 border-slate-200 focus:border-cyan-500 focus:ring-0 rounded-none">
              ...
              <div className="space-y-2">
                ...
                <Textarea placeholder={t('contactForm.messagePlaceholder')} className="min-h-[140px] bg-slate-50 border-slate-200 focus:border-cyan-500 focus:ring-0 rounded-none resize-none text-base p-4" />
              </div>

              <div className="pt-2">
                <Button type="button" className="w-full md:w-auto bg-[rgb(0,64,128)] hover:bg-cyan-600 text-white text-sm font-bold h-11 px-6 rounded-none transition-colors inline-flex items-center gap-2 [&_svg]:size-[18px]">
